...
//pub use deflate::ZlibEncoder as DeflateEncoder;
//pub use deflate::ZlibDecoder as DeflateDecoder;
    //pub use zlib::ZlibEncoder as ZlibEncoder;
    //pub use zlib::ZlibDecoder as ZlibDecoder;
//pub use gz::ZlibEncoder as GzEncoder;
